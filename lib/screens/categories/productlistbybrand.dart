...
class ProductListByBarndScreenActivity extends StatefulWidget {
  String subcategoriesid;
  String subcategoriesname;
  ProductListByBarndScreenActivity({
    super.key,
  ...
  @override
  State<ProductListByBarndScreenActivity> createState() =>
      _ProductListByBarndScreenActivityState();
}

class _ProductListByBarndScreenActivityState
    extends State<ProductListByBarndScreenActivity> {
  ProductListByBrandProvider _productDetails = ProductListByBrandProvider();
  ...
  void initState() {
    _productDetails =
        Provider.of<ProductListByBrandProvider>(context, listen: false);
    fetchdata();
  ...
  Widget build(BuildContext context) {
    return Consumer<ProductListByBrandProvider>(
